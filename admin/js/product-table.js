function getBookTable() {
  fetch("http://42.117.67.47:8080/api/dynamic-procedure/GetBookTable", {
    method: "POST",
  })
    .then(res => res.json())
    .then(x => {
...
function hideProduct(bookId) {
  ...
  fetch("http://42.117.67.47:8080/api/dynamic-procedure/HideBook", {
    method: "POST",
...
function displayBook(bookId) {
  ...
  //   return;
  fetch("http://42.117.67.47:8080/api/dynamic-procedure/DisplayBook", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(formData),
  })
...
function addNewProduct() {
  ...
  console.log(formData);
  //   return;
  fetch("http://42.117.67.47:8080/api/dynamic-procedure/AddNewBook", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(formData),
  })
...
async function fillCateDataAddForm() {
  const res = await fetch(
    "http://42.117.67.47:8080/api/dynamic-procedure/FillAllCategory",
    {
      method: "POST",
    }
  );
...
async function editBook(bookId) {
  ...
  fetch("http://42.117.67.47:8080/api/dynamic-procedure/FindBookById", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(formData),
  })
...
function editSubmit(bookId) {
  ...
  //   console.log(formData);
  //   return;
  fetch("http://42.117.67.47:8080/api/dynamic-procedure/UpdateBook", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(formData),
  })
