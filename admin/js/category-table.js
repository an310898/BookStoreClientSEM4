function getCategoryTable() {
  fetch("http://42.117.67.47:8080/api/dynamic-procedure/GetCategoryTable", {
    method: "POST",
  })
    .then(res => res.json())
    .then(x => {
...
function hideCate(cateId) {
  ...
  fetch("http://42.117.67.47:8080/api/dynamic-procedure/HideCate", {
    method: "POST",
...
function displayCate(cateId) {
  ...
  fetch("http://42.117.67.47:8080/api/dynamic-procedure/DisplayCate", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(formData),
  })
...
function addNewCategory() {
  ...
  //   return;
  fetch("http://42.117.67.47:8080/api/dynamic-procedure/AddNewCategory", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(formData),
  })
...
function editCate(cateId) {
  ...
  fetch("http://42.117.67.47:8080/api/dynamic-procedure/GetCategoryById", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
...
function editSubmit(cateId) {
  ...
  fetch("http://42.117.67.47:8080/api/dynamic-procedure/UpdateCategory", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(formData),
  })
