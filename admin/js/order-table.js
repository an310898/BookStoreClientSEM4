function getOrderTable() {
  fetch("http://42.117.67.47:8080/api/dynamic-procedure/GetOrderTable", {
    method: "POST",
  })
    .then(res => res.json())
    .then(x => {
...
async function getStatusOrder() {
  const res = await fetch(
    "http://42.117.67.47:8080/api/dynamic-procedure/GetEnumOrderStatus",
    {
      method: "POST",
    }
  );
...
function submitEditForm(orderId) {
  ...
  fetch("http://42.117.67.47:8080/api/dynamic-procedure/UpdateOrderStatus", {
    method: "POST",
